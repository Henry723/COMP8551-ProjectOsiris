...
Shader::Shader(const char* vertShaderPath, const char* fragShaderPath)
{
	...
	catch (std::ifstream::failure e)
	{
		...
		if (vShaderFile.badbit | fShaderFile.badbit)
		{
			std::cout << "::READ_WRITE_ERROR" << std::endl;
		}
		else if (vShaderFile.failbit | fShaderFile.failbit)
		{
			std::cout << "::LOGICAL_IO_ERROR" << std::endl;
		}
