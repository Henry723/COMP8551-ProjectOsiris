//============================================================================
// Configuration Manager - Presentation Class Interface
//
// Defines Presentation Layer Class for the Configuration Manager subsystem.
//
...
#ifndef __ConfigurationManager__CCfgMgrPresentation__
#define __ConfigurationManager__CCfgMgrPresentation__

#include <stdio.h>

class CCfgMgrPresentation
{
public:
    CCfgMgrPresentation();
    ~CCfgMgrPresentation();
...
#endif /* defined(__ConfigurationManager__CCfgMgrPresentation__) */